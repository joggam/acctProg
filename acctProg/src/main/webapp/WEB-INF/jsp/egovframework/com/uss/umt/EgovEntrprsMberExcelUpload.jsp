        ...
        <tr>
            ...
            <td class="left">
                ...
                <div style="margin-top:8px; line-height:1.7;">
                    입력 컬럼: 기업회원ID / 비밀번호 / 사업자등록번호 / 법인등록번호 / 회사명 / 주민등록번호 앞 6자리 / 주민등록번호 2번째 값 / 대표이사이름 / 신청자명 / 대표자 연락처 / 사업자구분 / 직원여부 / 차량구분<br/>
                    기업회원ID, 비밀번호, 사업자등록번호, 회사명, 주민등록번호 앞 6자리, 주민등록번호 2번째 값, 대표이사이름, 신청자명, 사업자구분, 직원여부, 차량구분은 필수입니다.<br/>
                    사업자구분: 법인(1) / 개인(2), 직원여부: 유(1) / 무(2), 차량구분: 무(1) / 불공차량 유(2) / 공제차량 유(3) 값을 사용할 수 있습니다.<br/>
                    사업자등록번호 또는 법인등록번호 중 최소 1개는 반드시 입력해야 합니다.<br/>
                    두 번호 모두 입력해도 되며, 하이픈(-)은 등록 시 제거되어 숫자만 저장됩니다.<br/>
                    대표자 연락처는 02-1234-5678 또는 010-1234-5678처럼 하이픈(-) 2개를 포함한 형식으로 입력해 주세요.
                </div>
            </td>
        </tr>
        <tr>
